...
class AddMemberForm(ModelForm):
    ...
    class Meta:
        ...
        'dob': forms.DateInput(attrs={'class': 'hasDatepicker form-control ', 'type': 'date'}),
...
class UpdateMemberInfoForm(forms.Form):
    ...
    dob            = forms.DateField(widget=forms.DateInput(attrs={'class': 'form-control hasDatepicker', 'type': 'text'}),)
